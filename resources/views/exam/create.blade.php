...
<!--        @if ($errors->any())
	...
	<div class="form-group ">
		...
		<div class="col-sm-10">
			<input type="text"  name="admin_name" class="form-control" id="firstname" placeholder="请输入品牌名称">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" name="pwd" class="form-control" id="brand_url"  placeholder="请输入品牌网址">
      ...
      <div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" name="repwd" class="form-control" id="brand_url"  placeholder="请输入品牌网址">
                        <b style="color:red">@php echo $errors->first('brand_url'); @endphp</b>
		</div>
	</div>
          <div class="form-group">
