...
<!--        @if ($errors->any())
    ...
    <b style="color:red">{{session('msg')}}</b>
        <form action="{{url('/exam/goods/update/'.$option.'/'.$data->goods_id)}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
            @csrf
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" name="goods_number" value='{{$data->goods_number}}' class="form-control" id="brand_url"  placeholder="请输入品牌网址">
